...
$rgVendedor = (isset($_POST['rgVendedor'])) ? $_POST['rgVendedor'] : ""; 

$enderecoVendedor = (isset($_POST['enderecoVendedor'])) ? $_POST['enderecoVendedor'] : "";
...
$_SESSION['enderecoVendedor'] = $enderecoVendedor;

$_SESSION['rgVendedor'] = $rgVendedor;
...
if(strlen($enderecoVendedor) > 40){
    ...
    $pdf->Cell(0, 10, iconv('UTF-8', 'windows-1252', $enderecoVendedor), 0, 0, 'L');
}else{
      $pdf->SetY(25.3);
...
$pdf->Cell(0, 10, $rgVendedor, 0, 0, 'L');
...
$pdf->SetFont('Arial','B',(strlen($enderecoComprador) > 100)? 9 : 11);
...
$pdf->SetFont('Arial','B',(strlen($outroPagamento) > 150)? 9 : 11);

//$pdf->Cell(0, 10, iconv('UTF-8', 'windows-1252', $outroPagamento), 0, 0, 'L');

$pdf->MultiCell(145, 3, iconv('UTF-8', 'windows-1252', $outroPagamento),0,'L', false);
...
$pdf->MultiCell(193, 3, iconv('UTF-8', 'windows-1252', $obsClausula),0,'L', false);
...
$caminhopdf ="pdf/sinal-".str_replace(" ", "-", $nomeComprador)."_dia_".$data."-hr-".$horas.".pdf";
