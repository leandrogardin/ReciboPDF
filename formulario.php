...
<body>
  ...
  <div class="container">
    ...
    Não esqueça de preencher este campo." class="form-control" name="nomeVendedor" value="<?php if (isset($_SESSION['vendedor']) and $_SESSION['vendedor'] != "Administrador") {
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control cpfvendedor" name="cpfCnpjVendedor" value="<?php if (isset($_SESSION['cpfCnpjVendedor'])) {
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nomeComprador" id="nomecomprador" value="<?php if (isset($_SESSION['nomeComprador'])) {
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="rgComprador" value="<?php if (isset($_SESSION['rgComprador'])) {
                ...
                <div class="col-md-5">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control cpfcomprador" id="cpfcomprador" name="cpfComprador" value="<?php if (isset($_SESSION['cpfComprador'])) {
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="enderecoComprador" maxlength="62" value="<?php if (isset($_SESSION['enderecoComprador'])) {
                ...
                <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control phone_with_ddd" name="foneComprador" value="<?php if (isset($_SESSION['foneComprador'])) {
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="emailComprador" maxlength="32" value="<?php if (isset($_SESSION['emailComprador'])) {
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nomeConjuge" value="<?php if (isset($_SESSION['nomeConjuge'])) {
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    <label class="bmd-label-floating">RG</label>
                    <input type="text" class="form-control" name="rgConjuge" value="<?php if (isset($_SESSION['rgConjuge'])) {
                ...
                <div class="col-md-5">
                  <div class="form-group">
                    <label class="bmd-label-floating">CPF/CNPJ/MF</label>
                    <input type="text" class="form-control cpfconjuge" name="cpfConjuge" value="<?php if (isset($_SESSION['cpfConjuge'])) {
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="descricaoImovel" value="<?php if (isset($_SESSION['descricaoImovel'])) {
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="numMatricula" value="<?php if (isset($_SESSION['numMatricula'])) {
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="cri" maxlength="23" value="<?php if (isset($_SESSION['cri'])) {
                                                                                                    echo $_SESSION['cri'];
                                                                                                  } ?>">
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control dinheiro" id="dinheiro" name="totalImovel" value="<?php if (isset($_SESSION['totalImovel'])) {
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control dinheiro" name="sinal" value="<?php if (isset($_SESSION['sinal'])) {
                                                                                                    echo $_SESSION['sinal'];
                                                                                                  } ?>">
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control dinheiro" name="financiamento" value="<?php if (isset($_SESSION['financiamento'])) {
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    <label class="bmd-label-floating">Outro</label>
                    <input type="text" class="form-control" name="outroPagamento" value="<?php if (isset($_SESSION['outroPagamento'])) {
                ...
                <div class="row">
                  <div class="form-group">
                    ...
                    <div class="custom-control custom-radio">
                      <input type="radio" id="especie" name="formapagamento" class="custom-control-input" value="especie" <?php
                    ...
                    <div class="custom-control custom-radio">
                      <input type="radio" id="deposito" name="formapagamento" class="custom-control-input" value="deposito" <?php
                    ...
                    <div class="custom-control custom-radio">
                      <input type="radio" id="cheque" name="formapagamento" class="custom-control-input" value="cheque" <?php
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="container">
                ...
                <div class="col-md-7">
                  <div class="form-group">                    
                    <input type="text" class="form-control input-sm" name="nomeConta" value="Vila Caiçara Imóveis Ltda" disabled>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">                    
                    <input type="text" class="form-control input-sm" name="cnpjConta" value="21.139.089/0001-41" disabled>
                  </div>
                </div>
              </div> -->
                ...
                <div class="row">
                  <div class="form-group">
                    ...
                    <div class="custom-control custom-radio">
                      <input type="radio" id="cef" name="contapagamento" class="custom-control-input" value="cef" <?php
                    ...
                    <div class="custom-control custom-radio">
                      <input type="radio" id="itau" name="contapagamento" class="custom-control-input" value="itau" <?php
                    ...
                    <div class="custom-control custom-radio">
                      <input type="radio" id="sicredi" name="contapagamento" class="custom-control-input" value="sicredi" <?php
        ...
        <div class="card">
            ...
            <div class="col-md-9">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="responsavel" value="<?php if (isset($_SESSION['responsavel'])) {
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="creci" value="<?php if (isset($_SESSION['creci'])) {
                                                                                                    echo $_SESSION['creci'];
                                                                                                  } ?>">
                  </div>
                </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text" id="4"><strong>Cláusula 4ª:</strong> As despesas com o ato da escritura (...)serão de exclusiva responsabilidade do/a:</span>
                   ...
                   <input type="text" class="form-control" id="" name="clausula4" aria-describedby="4" value="<?php if (isset($_SESSION['clausula4'])) {
              ...
              <div class="col-md-12">
                <div class="form-group">
                  <label class="bmd-label-floating">Obs</label>
                  <input type="text" class="form-control" name="obsClausula" placeholder="Linha 1" value="<?php if (isset($_SESSION['obsclausula'])) {
                                                                                                    echo $_SESSION['obsclausula'];
                                                                                                  } ?>">

                </div>
                <div class="form-group">
<input type="text" class="form-control" name="obsClausula2" placeholder="Linha 2" value="<?php if (isset($_SESSION['obsclausula2'])) {
                                                                                                    echo $_SESSION['obsclausula2'];
                                                                                                  } ?>">
              </div>
              </div>
  ...
  <div class="col-md-3">
                <div class="input-group">
                  ...
                  <span class="input-group-text" id="basic-cidade">Cidade</span>
                    ...
                    <input type="text" class="form-control form-control-sm "  name="cidade" aria-describedby="basic-cidade" value="<?php if (isset($_SESSION['cidade'])) {
                ...
                <div class="input-group">
                  ...
                  <span class="input-group-text" id="basic-mes">Data</span>
                    ...
                    <input type="text" class="form-control form-control-sm "  name="diames" aria-describedby="basic-mes" value="<?php if (isset($_SESSION['diames'])) {
    ...
    <div class="row">
                <div class="col-md-8">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control " id="nomecompradorrodape" name="nomecompradorrodape" value="<?php if (isset($_SESSION['nomecompradorrodape'])) {
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control cpf" id="cpfcompradorrodape" name="cpfcompradorrodape" value="<?php if (isset($_SESSION['cpfcompradorrodape'])) {
...
<br>
           <div class="row">
                <div class="col-md-8">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control "  name="nometestemunha1" value="<?php if (isset($_SESSION['nometestemunha1'])) {
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label class="bmd-label-floating">CPF/MF</label>
                    <input type="text" class="form-control cpf" name="cpftestemunha1" value="<?php if (isset($_SESSION['cpftestemunha1'])) {
           ...
           <div class="row">
                <div class="col-md-8">
                  <div class="form-group">
                    <label class="bmd-label-floating">Nome Testemunha</label>
                    <input type="text" class="form-control "  name="nometestemunha2" value="<?php if (isset($_SESSION['nometestemunha2'])) {
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label class="bmd-label-floating">CPF/MF</label>
                    <input type="text" class="form-control cpf " name="cpftestemunha2" value="<?php if (isset($_SESSION['cpftestemunha2'])) {
